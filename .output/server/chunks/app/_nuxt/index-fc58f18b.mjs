...
import { ref, defineComponent, computed, openBlock, createElementBlock, mergeProps, unref, renderSlot, useAttrs as useAttrs$1, useSlots, shallowRef, watch, nextTick, toRef, createCommentVNode, Fragment, normalizeClass, createElementVNode, createBlock, withCtx, resolveDynamicComponent, withModifiers, createVNode, toDisplayString, normalizeStyle, provide, reactive, onUpdated, inject, withDirectives, cloneVNode, Text, Comment, Teleport, Transition, vShow, readonly, isRef, vModelCheckbox, createTextVNode, toRefs, toHandlers, withKeys, getCurrentInstance, renderList, watchEffect, h, onUnmounted, useSSRContext, warn, toRaw, getCurrentScope, onScopeDispose, resolveComponent, resolveDirective, vModelText, render } from 'vue';
...
import { isNil, pick, isEqual, debounce, fromPairs, isUndefined as isUndefined$1, castArray, get, findLastIndex, merge, set, flatMap } from 'lodash-unified';
import { NOOP, isObject, isString as isString$1, hasOwn, isFunction, isArray, toRawType } from '@vue/shared';
...
const TIMELINE = [
  ...
  },
  {
    ...
    slideImage: "https://img.zcool.cn/community/01577f5988194e0000002129278001.gif",
    shouldDrawLine: true,
    alignment: "leftSide"
    /* LEFT */
  },
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_el_row = ElRow;
      const _component_el_col = ElCol;
      _push(`<!--[--><h2 class="section-title-sm seq mb-4" data-v-fee3536b>${ssrInterpolate(_ctx.title)}</h2><div class="${ssrRenderClass(`${_ctx.willChange && "will-change-opacity"} seq flex flex-wrap`)}" data-v-fee3536b>`);
          ...
          if (_push2) {
            ...
            ssrRenderList(_ctx.members, (member, idx) => {
              _push2(ssrRenderComponent(_component_el_col, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<a${ssrRenderAttr("href", member.url)} title="\u70B9\u51FB\u67E5\u770B\u8BE6\u7EC6\u4FE1\u606F" data-v-fee3536b${_scopeId2}><div class="grid-content" data-v-fee3536b${_scopeId2}><h5 data-v-fee3536b${_scopeId2}>\u59D3\u540D\uFF1A${ssrInterpolate(member.name)}</h5><h5 data-v-fee3536b${_scopeId2}>\u7C4D\u8D2F\uFF1A${ssrInterpolate(member.city)}</h5><h5 data-v-fee3536b${_scopeId2}>\u5E74\u7EA7\uFF1A${ssrInterpolate(member.grade)}</h5><h5 data-v-fee3536b${_scopeId2}>\u7814\u7A76\u5174\u8DA3\uFF1A${ssrInterpolate(member.interest)}</h5><h5 data-v-fee3536b${_scopeId2}>\u73B0\u72B6\uFF1A${ssrInterpolate(member.status)}</h5></div></a>`);
                  } else {
                    return [
                      createVNode("a", {
                        href: member.url,
...
const renderMemberColumn = /* @__PURE__ */ _export_sfc$1(_sfc_main$8, [["__scopeId", "data-v-fee3536b"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-7acef66c><div class="${ssrRenderClass(`flex flex-col inner-container  ${willChange.value && "will-change-transform"}`)}" data-v-7acef66c><p class="seq section-title-sm" data-v-7acef66c> WORKS </p><h1 class="seq section-heading mt-2" data-v-7acef66c> \u7814\u7A76\u6210\u679C </h1><h2 class="seq mt-2 max-w-sm w-full text-2xl md:max-w-3xl" data-v-7acef66c> \u8F66\u8054\u7F51\u3001\u8FB9\u7F18\u8BA1\u7B97\u3001\u7A7A\u5929\u5730\u534F\u540C </h2></div><div class="seq gaodu project-wrapper grid auto-cols-max grid-flow-col w-fit snap-x snap-mandatory scroll-pl-6 gap-6 md:gap-10" data-v-7acef66c><!--[-->`);
      ...
      _push(`<!--]--></div><div class="mycollapse mt-6 Transparent line-height-normal mb-20" data-v-7acef66c>`);
            ...
            _push2(ssrRenderComponent(_component_el_collapse_item, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="pagination-block" data-v-7acef66c${_scopeId2}>`);
...
const ProjectsSection = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["__scopeId", "data-v-7acef66c"]]);
...
//# sourceMappingURL=index-fc58f18b.mjs.map
